...
public interface Service
     ...
     *
     * @throws net.schmizz.sshj.common.SSHException if the packet is unexpected and may represent a disruption
     */
     ...
     * service}.
     *
     * @throws net.schmizz.sshj.transport.TransportException if there is an error sending the service request
     */
    void request()
