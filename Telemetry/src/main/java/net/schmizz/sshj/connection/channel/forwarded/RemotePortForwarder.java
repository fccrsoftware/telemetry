...
public class RemotePortForwarder
     ...
     *
     * @throws net.schmizz.sshj.connection.ConnectionException if there is an error requesting the forwarding
     * @throws net.schmizz.sshj.transport.TransportException
     */
     ...
     *
     * @throws net.schmizz.sshj.connection.ConnectionException if there is an error with the cancellation request
     * @throws net.schmizz.sshj.transport.TransportException
     */
