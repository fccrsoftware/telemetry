...
final class KeyExchanger
    ...
    /**
     * {@link net.schmizz.sshj.transport.verification.HostKeyVerifier#verify(String, int, java.security.PublicKey)} is invoked by {@link #verifyHost(java.security.PublicKey)}
     ...
     * <p/>
     * Any of the {@link net.schmizz.sshj.transport.verification.HostKeyVerifier} implementations added this way can deem a host key to be acceptable, allowing
     * key exchange to successfuly complete. Otherwise, a {@link TransportException} will result during key exchange.
     *
     * @param hkv object whose {@link net.schmizz.sshj.transport.verification.HostKeyVerifier#verify} method will be invoked
     */
