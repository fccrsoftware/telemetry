...
public class PKCS8KeyFile
    ...
    protected org.spongycastle.openssl.PasswordFinder makeBouncyPasswordFinder() {
        if (pwdf == null)
            return null;
        else
            return new org.spongycastle.openssl.PasswordFinder() {
                @Override
    ...
    protected KeyPair readKeyPair()
            throws IOException {
        KeyPair kp = null;
        org.spongycastle.openssl.PasswordFinder pFinder = makeBouncyPasswordFinder();
        PEMParser r = null;
        Object o = null;
        try {
            for (; ; ) {
